...
path_1 = '/LearnModules/PythonBuildinModules/ospath'
path_2 = '/Playground'
...
print(os.path.exists('/LearnModules/PythonBuildinModules/ospath'))  # True
print(os.path.exists('/LearnModules/PythonBuildinModules/ospath/'))  # True
print(os.path.exists('/LearnModules/PythonBuildinModules/ospath/note.md'))  # True
...
print(os.path.getatime('/LearnModules/PythonBuildinModules/ospath/'))  # 访问时间
print(os.path.getmtime('/LearnModules/PythonBuildinModules/ospath/'))  # 修改时间
print(os.path.getctime('/LearnModules/PythonBuildinModules/ospath/'))  # 创建时间
...
print(os.path.isabs('/LearnModules/PythonBuildinModules/ospath/'))  # True
...
print(
    os.path.samefile('/LearnModules/PythonBuildinModules/ospath/note.md', './note.md'))  # True

# os.path.split(path)
# 将路径名路径拆分为一对 (head, tail)，其中 tail 是最后一个路径名组件，head 该组件之前的所有内容。如果路径以斜杠结尾，则tail将为空。
# 如果 path 为空，则 head 和 tail 都为空。
print(os.path.split(
    '/LearnModules/PythonBuildinModules/ospath'))  # ('/Users/zjx/PycharmProjects/LearnPython/PythonBuildinModules', 'ospath')
print(os.path.split(
    '/LearnModules/PythonBuildinModules/ospath/'))  # ('/Users/zjx/PycharmProjects/LearnPython/PythonBuildinModules/ospath', '')
